...
class HomeFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'rodape' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'sub_titulo' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
    ...
    public $records = [
        [
            ...
            'rodape' => 'Lorem ipsum dolor sit amet',
