...
/**
 * RepresentantesFixture
 *
 */
class RepresentantesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_cidade_id' => ['type' => 'index', 'columns' => ['cidade_id'], 'length' => []],
            'fk_estado_id' => ['type' => 'index', 'columns' => ['estado_id'], 'length' => []],
        ],
        '_constraints' => [
